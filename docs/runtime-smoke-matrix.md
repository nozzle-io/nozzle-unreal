...
| Unreal sender -> nozzle-viewer | Editor PIE | 641x479 | #140/#159 PASS evidence: UE 5.7.4, macOS 15.4.1, Apple M4/Metal, `unreal_metal_blit_to_iosurface`, `MTLPixelFormat=80`, `641x479`, IOSurface-backed intermediate with non-zero IOSurface ID, `usage=0x3`, `FRHIGPUFence` source sync before the cross-queue IOSurface copy, Metal intermediate blit `waitUntilCompleted`, and nozzle ring publish completion wait; runtime log contained no `SubmitAndBlockUntilGPUIdle` or `RHIBlockUntilGPUIdle`; viewer JSON proved 641x479, orientation/channel order, alpha patch, moving marker, and five distinct frames. SHAs: nozzle-unreal runtime harness `a040e669c895340ed7426e7217b7f99034b78b59`, nozzle-viewer `fb5426b4dbaabb71e53120a74800db14806f1d08`, core `65316f0b226db1ccd39380b14694157c41d08cc1`. Evidence files: UE log `/private/tmp/nozzle_unreal_140_641_ue_2.log`, viewer JSON `/private/tmp/nozzle_unreal_140_641_viewer_2.json`. | PASS (#140, #159) |
